...
/* ---------------------------------------------------------------------- */
/* McuShell */
#define McuShell_CONFIG_PROJECT_NAME_STRING         "Sample"
...
#define McuSemihost_CONFIG_CUT_FILENAME_PREFIX_STR  "/workspace/" /* DevContainer path for workspace. GDB server (on the host) needs to have cwd in the project root! */
/* ---------------------------------------------------------------------------------------*/
/* McuRdimon */
